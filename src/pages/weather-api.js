...
export function getEmoji(desc = "") {
  ...
  if (d.includes("sun") || d.includes("clear")) return "солячно";
  if (d.includes("cloud")) return "хмарно";
  if (d.includes("rain")) return "дощ";
  if (d.includes("snow")) return "сніг";
  if (d.includes("storm") || d.includes("thunder")) return "гроза";
  if (d.includes("fog") || d.includes("mist")) return "туман";
  return "мало хмар";
}
