...
export default function MyCity() {
  ...
  return (
    ...
    >
      {}
      <h2 style={{ color: "#4f46e5", marginBottom: "8px" }}>
        Моє місто — Шпола
      </h2>
      <p style={{ color: "#475569", lineHeight: "1.7", marginBottom: "24px" }}>
        Шпола — місто у Черкаській області України, розташоване в центральній
        частині країни. Вважається географічним центром України. Місто засноване
        у 16 столітті, має спокійну атмосферу, мальовничу природу та привітних
        мешканців. Населення — близько 18 000 людей.
      </p>
